...
def page_six():
    ...
    food = pd.read_csv("C:/Users/Admin\OneDrive/Desktop/Hashu Eatz/Streamlit/resources/input/food.csv")
    
    ratings = pd.read_csv("C:/Users/Admin\OneDrive/Desktop/Hashu Eatz/Streamlit/resources/input/ratings.csv")
